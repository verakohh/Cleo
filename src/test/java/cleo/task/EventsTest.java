...
public class EventsTest {
    ...
    public void testValidEventCreation() {
        Events event = new Events("Project Meeting", "2024-12-01 14:00", "2024-12-01 16:00", "P3");
    ...
    public void testEventWithPastStartDate() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
            new Events("Project Meeting", "2022-12-01 14:00", "2024-12-01 16:00", "P3"));
    ...
    public void testEventWithPastEndDate() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
            new Events("Project Meeting", "2024-12-01 14:00", "2022-12-01 16:00", "P3"));
        assertEquals("The date(s) cannot be in the past!", exception.getMessage());
    }
    ...
    public void testEventWithEndBeforeStart() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
            new Events("Project Meeting", "2024-12-01 16:00", "2024-12-01 14:00", "P3"));
    ...
    public void testInvalidDateFormat() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
            new Events("Project Meeting", "2024-12-01", "2024-12-01 16:00", "P3"));
